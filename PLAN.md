...
974,049 bytes. An explicit project decision raises the enforced artifact ceiling to 10,000,000
bytes, leaving 9,025,951 bytes of headroom. Model/schema checks, 70 artifact invariants, all 29
